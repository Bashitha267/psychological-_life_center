...
<head>
    ...
    <title>Our Services - SereneMind</title>
...
<body class="font-sans bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center">
                ...
                <ul class="hidden md:flex space-x-8">
                    ...
                    <li><a href="services.php" class="text-primary font-semibold">Services</a></li>
            ...
            <div class="mobile-menu-overlay md:hidden">
                <ul class="flex flex-col space-y-4 p-6">
                    ...
                    <li><a href="services.php" class="text-dark font-medium text-lg hover:text-primary transition-colors border-b-2 border-primary pb-2 block">Services</a></li>
    ...
    <section class="relative bg-gradient-to-br from-arctic via-white to-secondary/10 py-24">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <h1 class="text-5xl md:text-6xl font-display font-semibold text-dark mb-6">Our Services</h1>
            <p class="text-xl text-light max-w-3xl mx-auto">Comprehensive mental health care solutions designed for your well-being</p>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 space-y-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center" id="service-<?php echo $service['id']; ?>">
                <div class="<?php echo ($service['id'] % 2 == 0) ? 'md:order-2' : ''; ?>">
                    <div class="w-full h-80 rounded-3xl overflow-hidden shadow-lg bg-arctic flex items-center justify-center">
                        <img src="<?php echo $service['icon']; ?>" alt="<?php echo $service['title']; ?>" class="w-48 h-48 object-contain">
                    </div>
                </div>
                <div class="<?php echo ($service['id'] % 2 == 0) ? 'md:order-1' : ''; ?>">
                    <div class="inline-block bg-gradient-to-r from-primary to-secondary text-white px-4 py-1.5 rounded-full text-sm font-semibold mb-4">
                        Service <?php echo str_pad($service['id'], 2, '0', STR_PAD_LEFT); ?>
                    </div>
                    <h2 class="text-3xl md:text-4xl font-display font-semibold text-dark mb-4"><?php echo $service['title']; ?></h2>
                    <p class="text-lg text-light mb-6"><?php echo $service['description']; ?></p>
                    <p class="text-light mb-8"><?php echo $service['details']; ?></p>
                    <a href="contact.php" class="inline-block px-8 py-3.5 bg-gradient-to-r from-primary to-secondary text-white font-semibold rounded-full shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
    ...
    <section class="py-20 bg-gradient-to-r from-arctic to-white">
        <div class="max-w-4xl mx-auto px-4 text-center">
            <h2 class="text-4xl font-display font-semibold text-dark mb-6">Ready to Start Your Journey?</h2>
            <p class="text-lg text-light mb-10">Take the first step towards better mental health. Our team is here to support you.</p>
